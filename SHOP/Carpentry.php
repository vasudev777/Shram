...
<div class="container-fluid">
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <span class="breadcrumb-item active">Carpentry</span>
                </nav>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid pt-5 pb-3">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Carpentry Product</span></h2>
        <div class="row px-xl-5">
    <?php      $sql = "SELECT * FROM `items` WHERE i_type='Carpentor';";
