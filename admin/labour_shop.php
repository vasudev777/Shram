    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Labour Shop History</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
              ...
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <?php
                         $sql = "SELECT *FROM labour_details JOIN labour_item_history ON labour_details.l_id = labour_item_history.l_id;";
