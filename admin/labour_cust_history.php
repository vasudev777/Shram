...
<body>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>Labour - Customer Booking History</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item active">Labour Customer History</li>
        </ol>
      </nav>
    </div>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card recent-sales overflow-auto">
            <div class="card-body">
              <h5 class="card-title">Labour - Customer Booking Details</h5>
              <table class="table table-borderless datatable">
                ...
                <?php
                  $sql = "SELECT
                          ...
                          ORDER BY labour_details.l_name ASC, labour_cust_book.lc_date DESC";
