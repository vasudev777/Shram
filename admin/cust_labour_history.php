...
<body>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>Customer - Labour Booking History</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item active">Customer Labour History</li>
        </ol>
      </nav>
    </div>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card recent-sales overflow-auto">
            <div class="card-body">
              <h5 class="card-title">Customer - Labour Booking Details</h5>
              <table class="table table-borderless datatable">
                <thead>
                <?php
                  // ✅ 3 Tables JOIN - Customer + Labour + Booking
                  $sql = "SELECT
                            ...
                            labour_details.l_city AS l_city,
                            labour_cust_book.lc_id, labour_cust_book.lc_date,
                            labour_cust_book.lc_note, labour_cust_book.lc_status
                          ...
                          ORDER BY labour_cust_book.lc_date DESC";
