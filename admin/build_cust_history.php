...
<body>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>Builder - Customer Booking History</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item active">Builder Customer History</li>
        </ol>
      </nav>
    </div>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card recent-sales overflow-auto">
            <div class="card-body">
              <h5 class="card-title">Builder - Customer Booking Details</h5>
              <table class="table table-borderless datatable">
                ...
                <?php
                  $sql = "SELECT
                            ...
                            build_cust_book.build_book_id,
                            build_cust_book.build_book_date,
                            build_cust_book.build_book_note,
                            build_cust_book.build_book_status
                          ...
                          ORDER BY build_details.b_name ASC, build_cust_book.build_book_date DESC";
