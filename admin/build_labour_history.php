...
<body>
  ...
  <main id="main" class="main">
    <div class="pagetitle">
      <h1>Builder - Labour Booking History</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item active">Builder Labour History</li>
        </ol>
      </nav>
    </div>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card recent-sales overflow-auto">
            <div class="card-body">
              <h5 class="card-title">Builder - Labour Booking Details</h5>
              <table class="table table-borderless datatable">
                ...
                <?php
                  $sql = "SELECT
                          ...
                          ORDER BY build_details.b_name ASC, build_labour_book.build_labour_book_date DESC";
