...
$sql    = "SELECT * FROM labour_details WHERE l_token='$token' AND l_emailverify='0'";
...
if(mysqli_num_rows($result) == 1) {
    ...
    // Email verify karo
    mysqli_query($conn, "UPDATE labour_details SET l_emailverify='1' WHERE l_token='$token'");
    ...
    try {
        ...
        $mail->isHTML(true);
        $mail->Subject = 'Email Verified - Pending Admin Approval | Shram Labour';
        $mail->Body    = "
        <div style='font-family:Arial,sans-serif;max-width:620px;margin:auto;border:1px solid #eee;border-radius:15px;overflow:hidden;'>
            ...
            <div style='padding:25px 30px;background:#fafafa;'>
                ...
                <div style='margin:12px 0;'>
                    <span style='background:#fff3cd;color:#856404;padding:5px 12px;border-radius:20px;font-size:12px;font-weight:bold;'>⏳ Admin Approval Pending</span>
                </div>
            </div>
            <div style='padding:20px 30px;background:#fff9e6;border-left:4px solid #fcbc04;margin:0 20px 20px;border-radius:8px;'>
                <p style='margin:0;color:#555;font-size:14px;line-height:1.7;'>
                    Your account is under review. You will receive an email once approved. This usually takes <b>24-48 hours</b>.
                </p>
            </div>
            <div style='padding:25px 30px;text-align:center;'>
                <a href='https://shram.free.nf/Labour/login.php' style='background:#fcbc04;color:#000;padding:13px 40px;border-radius:25px;text-decoration:none;font-weight:bold;font-size:15px;display:inline-block;'>
                    Go to Login
                </a>
            </div>
    ...
    <head>
      ...
      <title>Email Verified - Shram Labour</title>
        ...
        <section class="section min-vh-100 d-flex flex-column align-items-center justify-content-center py-4">
          <div class="col-lg-5 col-md-7">
            <div class="card text-center p-4">
              ...
              <p style="color:#666;font-size:14px;">Your email has been verified. Your account is pending admin approval.</p>
