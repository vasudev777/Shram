...
<body>
                  ...
                  ?>
                    <tr>
                      ...
                      <?php if ($status == '0') { ?>
                        ...
                        <td>
                          <a href="build_req_process.php?blockid=<?php echo $row['build_labour_book_id']; ?>">
  ...
  function rejectRequest(id) {
    ...
    window.location = "build_req_process.php?unblockid=" + id + "&reason=" + encodeURIComponent(reason);
  }
  </script>
