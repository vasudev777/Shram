                ...
                <table class="table table-borderless datatable">
                  ...
                  <?php
                    ...
                    $sql = "SELECT * FROM labour_details
                            ...
                            WHERE labour_details.l_id='$id'
                            AND labour_cust_book.lc_status != '2'";
                  ...
                  ?>
                    <tr>
                      ...
                      <?php if ($status == '0') { ?>
                        <!-- ✅ Pending — dono buttons -->
                        <td>
                          <a href="javascript:void(0)"
                             onclick="rejectRequest(<?php echo $row['lc_id']; ?>)">
                            <span class="badge bg-danger">Reject</span>
                          </a>
                        </td>
                        <td>
                          <a href="cust_req_process.php?blockid=<?php echo $row['lc_id']; ?>">
                  ...
                  <?php
                      ...
                      echo "<tr><td colspan='7' style='text-align:center;color:#aaa;padding:20px;'>No pending requests found</td></tr>";
                    }
                  }
                  ?>
                </table>
