...
?>
   ...
   <!-- End Header -->
     ...
     <center>
             <div class="col-lg-6">
             <div id="sender">
               <form action="Appointment_process.php" method="post"  class="form-control">
                 <div class="row gy-4">
                 <center>  
                 <div class="col-lg-8 form-group">
                   <input type="date" name="date"  class="form-control" placeholder="Your Name"   required>
                   <input type="text" name="lid" value="<?php echo $lid;  ?>" class="form-control" placeholder="Your Name"   hidden>
