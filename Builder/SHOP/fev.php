        ...
        <div class="row px-xl-5">
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <?php      $sql1 = "SELECT *FROM items JOIN build_fev_item ON items.i_id = build_fev_item.item_id JOIN build_details ON build_fev_item.b_id = build_details.b_id where build_details.b_id='$id';";
                   // echo $sql1;
