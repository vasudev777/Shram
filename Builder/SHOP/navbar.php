            ...
            <div class="col-lg-3 d-none d-lg-block">
                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 999;">
                    <div class="navbar-nav w-100">
                        ...
                        <a href="" class="nav-item nav-link">Masonry</a>
                        <a href="" class="nav-item nav-link">Welding</a>
                        <a href="" class="nav-item nav-link">Plumbing</a>
                        <a href="" class="nav-item nav-link">Carpentry</a>
                        <a href="" class="nav-item nav-link">Painting</a>
                        <a href="" class="nav-item nav-link">Electrician</a>
            ...
            echo "<script>window.location='../login.php'</script>";  
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            <a href="" class="btn px-0">
                                ...
                                <?php
                                        $query = "SELECT * FROM build_fev_item where b_id=$id";
                                       // echo $query;
                            ...
                            <a href="" class="btn px-0 ml-3">
                                ...
                                <span class="badge text-secondary border border-secondary rounded-circle" style="padding-bottom: 2px;">
                                <?php
                                        $query = "SELECT * FROM build_cart where b_id=$id";
                                        $result = mysqli_query($conn, $query);
                                        if ($result) {
                                            // it return number of rows in the table.
                                            $row = mysqli_num_rows($result);
