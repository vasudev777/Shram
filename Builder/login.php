...
<head>
  ...
  <title>SHRAM - Builder Login</title>
  ...
  <style>
    ...
    .btn-shram:hover { background: #0b5ed7; }
    .btn-google {
      background: #fff;
      color: #333;
      font-weight: bold;
          ...
          <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
            ...
            <div class="d-flex justify-content-center py-4">
              <a href="index.php" class="logo d-flex align-items-center w-auto">
                <span class="d-none d-lg-block" style="font-size:24px;font-weight:bold;">Shram<span style="color:#0d6efd;">.</span></span>
              </a>
            </div>

            <div class="login-box">
              <h5 class="text-center mb-4" style="font-size:20px;font-weight:bold;">Builder Login</h5>
              ...
              <div class="tab-content active" id="tab-password">
                <form action="builder_login_process.php" method="post">
              ...
              <div class="tab-content" id="tab-otp">
                <form action="builder_send_otp.php" method="post">
              ...
              <div style="text-align:center;margin-top:20px;font-size:14px;color:#666;">
                Don't have an account? <a href="reg.php" style="color:#0d6efd;font-weight:bold;">Apply Now</a>
              </div>
...
<script>
  // Firebase Config — connection-shram wala
